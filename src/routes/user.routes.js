...
import { getAll, getByIdCompanyUser, getByIdUser, login, register, resendEmail, update, verifyEmail } from '../controllers/user.controller.js';
...
router.post('/resendEmail', validateLoginMiddleware, resendEmail);
